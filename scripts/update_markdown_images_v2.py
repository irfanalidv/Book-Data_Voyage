...
def add_image_displays_to_markdown():
    ...
    chapters_with_images = {
        'ch01': ['data_science_venn_diagram.png', 'ethics_framework.png', 'correlation_heatmap.png', 
                 'daily_sales_trend.png', 'data_science_workflow.png', 'industry_applications.png', 
                 'sales_distribution.png', 'skills_radar_chart.png'],
        'ch03': ['ab_testing.png', 'correlation_regression.png', 'data_distribution.png', 
                 'financial_analysis.png', 'hypothesis_testing.png', 'linear_algebra.png', 
                 'probability_distributions.png', 'quality_control.png'],
        ...
        'ch11': ['unsupervised_datasets.png', 'dimensionality_reduction.png', 'clustering_results.png'],
        'ch12': ['activation_functions.png', 'neural_network_results.png', 'training_optimization.png'],
        'ch13': ['text_preprocessing.png', 'text_representation.png', 'nlp_applications.png'],
        'ch14': ['image_processing.png', 'feature_extraction.png', 'cv_applications.png'],
        'ch15': ['time_series_components.png', 'seasonal_decomposition.png', 'stationarity_analysis.png', 
                 'time_series_forecasting.png', 'forecast_residuals.png'],
...
def update_summary_with_images(summary_path, image_files, chapter):
    ...
    if "## Generated Outputs and Visualizations" in content:
        ...
        new_section = create_visualizations_section(image_files, chapter, is_summary=True)
...
def get_image_description(image_file):
    ...
    return descriptions.get(base_name, f'Visualization of {base_name.replace("_", " ")}')
